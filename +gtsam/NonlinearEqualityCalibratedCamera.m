  ...
  methods
    function obj = NonlinearEqualityCalibratedCamera(varargin)
      ...
      elseif nargin == 2 && isa(varargin{1},'numeric') && isa(varargin{2},'gtsam.CalibratedCamera')
        [ my_ptr, base_ptr ] = gtsam_wrapper(2332, varargin{1}, varargin{2});
    ...
    function delete(obj)
      gtsam_wrapper(2334, obj.ptr_gtsamNonlinearEqualityCalibratedCamera);
    end
  ...
  methods(Static = true)
    function varargout = string_deserialize(varargin)
      ...
      if length(varargin) == 1
        varargout{1} = gtsam_wrapper(2336, varargin{:});
      else
